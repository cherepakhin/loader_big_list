...
~~1. Прикрутить какую-нибудь Arango (https://github.com/cherepakhin/arango-data) , как средство обработки/получения данных~~ (нельзя по условиям задачи)
~~2. Или другую вертикальную БД~~ (нельзя по условиям задачи)
